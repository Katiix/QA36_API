...
public class RegistrationTestsOkhttp {
    ...
    public void registrationSuccess() throws IOException {
        ...
        AuthRequestDto auth = AuthRequestDto.builder().username("kate"+i+"@gmail.com").password("Kkate12345$").build();
    ...
    public void registrationWrongEmail() throws IOException {
        AuthRequestDto auth = AuthRequestDto.builder().username("kategmail.com").password("Kkate12345$").build();
        RequestBody body = RequestBody.create(gson.toJson(auth), JSON);
    ...
    public void registrationWrongPassword() throws IOException {
        int i = new Random().nextInt(1000) + 1000;
        AuthRequestDto auth = AuthRequestDto.builder().username("kate" + i+ "@gmail.com").password("kate125$").build();
        RequestBody body = RequestBody.create(gson.toJson(auth), JSON);
    ...
    public void registrationExistingUser() throws IOException {
        AuthRequestDto auth = AuthRequestDto.builder().username("kate@gmail.com").password("Kkate12345$").build();
        RequestBody body = RequestBody.create(gson.toJson(auth), JSON);
